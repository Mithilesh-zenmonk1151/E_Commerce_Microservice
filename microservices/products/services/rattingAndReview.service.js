...
exports.editRattingAndReview = async (payload) => {
  try {
    ...
    const updatedRattingAndReview =
      await rattingAndReviewModel.rattingAndReviewModel.findByIdAndUpdate(
        rattingAndReviewId,
        { ratting: ratting, review: review },
        { new: true }
      );
...
exports.deleteRattingAndReview = async (payload) => {
  try {
    const { rattingAndReviewId } = payload.params;
    const deleteRattingAndReview =
      await rattingAndReviewModel.rattingAndReviewModel.findByIdAndDelete(
        rattingAndReviewId
      );
